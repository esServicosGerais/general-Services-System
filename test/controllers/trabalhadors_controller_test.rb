...
class TrabalhadorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabalhador" do
    assert_difference("Trabalhador.count") do
      post trabalhadors_url, params: { trabalhador: { cpf/cnpj: @trabalhador.cpf/cnpj, dataNascimento: @trabalhador.dataNascimento, email: @trabalhador.email, endereco_id: @trabalhador.endereco_id, nome: @trabalhador.nome, profissão: @trabalhador.profissão, telefone: @trabalhador.telefone } }
    end
  ...
  test "should update trabalhador" do
    patch trabalhador_url(@trabalhador), params: { trabalhador: { cpf/cnpj: @trabalhador.cpf/cnpj, dataNascimento: @trabalhador.dataNascimento, email: @trabalhador.email, endereco_id: @trabalhador.endereco_id, nome: @trabalhador.nome, profissão: @trabalhador.profissão, telefone: @trabalhador.telefone } }
